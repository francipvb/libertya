 ...
 *  @version  - 2019-08-29 23:35:54.181 */
...
try 
{
 		 ...
 		 String sql = " INSERT INTO C_User_Authorization(C_User_Authorization_ID,AD_Client_ID,AD_Org_ID,IsActive,Created,CreatedBy,Updated,UpdatedBy,AD_Process_ID,AD_User_Login_ID,AD_User_Auth_ID,C_Invoice_ID,Amount,Percentage,AuthTime,OperationLog" + getAdditionalParamNames() + ") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?" + getAdditionalParamMarks() + ") ";
