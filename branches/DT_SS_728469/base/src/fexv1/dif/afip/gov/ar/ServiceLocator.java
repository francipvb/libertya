...
public class ServiceLocator extends org.apache.axis.client.Service implements fexv1.dif.afip.gov.ar.Service {
 ...
 */
    ...
    private java.lang.String ServiceSoap_address = "https://servicios1.afip.gov.ar/wsfexv1/service.asmx";
    ...
    public fexv1.dif.afip.gov.ar.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fexv1.dif.afip.gov.ar.ServiceSoapStub _stub = new fexv1.dif.afip.gov.ar.ServiceSoapStub(portAddress, this);
    ...
    private java.lang.String ServiceSoap12_address = "https://servicios1.afip.gov.ar/wsfexv1/service.asmx";
    ...
    public fexv1.dif.afip.gov.ar.ServiceSoap getServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            fexv1.dif.afip.gov.ar.ServiceSoap12Stub _stub = new fexv1.dif.afip.gov.ar.ServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (fexv1.dif.afip.gov.ar.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                fexv1.dif.afip.gov.ar.ServiceSoapStub _stub = new fexv1.dif.afip.gov.ar.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
            if (fexv1.dif.afip.gov.ar.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                fexv1.dif.afip.gov.ar.ServiceSoap12Stub _stub = new fexv1.dif.afip.gov.ar.ServiceSoap12Stub(new java.net.URL(ServiceSoap12_address), this);
                _stub.setPortName(getServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ServiceSoap12"));
        }
