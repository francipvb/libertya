...
public class FEXResponse_Opc  implements java.io.Serializable {
    private fexv1.dif.afip.gov.ar.ClsFEXResponse_Opc[] FEXResultGet;

    private fexv1.dif.afip.gov.ar.ClsFEXErr FEXErr;

    private fexv1.dif.afip.gov.ar.ClsFEXEvents FEXEvents;

    public FEXResponse_Opc() {
    }

    public FEXResponse_Opc(
           fexv1.dif.afip.gov.ar.ClsFEXResponse_Opc[] FEXResultGet,
    ...
    /**
     * Gets the FEXResultGet value for this FEXResponse_Opc.
     * 
     * @return FEXResultGet
     */
    public fexv1.dif.afip.gov.ar.ClsFEXResponse_Opc[] getFEXResultGet() {
        return FEXResultGet;
    }


    /**
     * Sets the FEXResultGet value for this FEXResponse_Opc.
     * 
     * @param FEXResultGet
     */
    public void setFEXResultGet(fexv1.dif.afip.gov.ar.ClsFEXResponse_Opc[] FEXResultGet) {
        this.FEXResultGet = FEXResultGet;
    }


    /**
     * Gets the FEXErr value for this FEXResponse_Opc.
     * 
     * @return FEXErr
     */
    ...
    /**
     * Sets the FEXErr value for this FEXResponse_Opc.
     * 
     * @param FEXErr
     */
    ...
    /**
     * Gets the FEXEvents value for this FEXResponse_Opc.
     * 
     * @return FEXEvents
     */
    ...
    /**
     * Sets the FEXEvents value for this FEXResponse_Opc.
     * 
     * @param FEXEvents
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FEXResponse_Opc)) return false;
        FEXResponse_Opc other = (FEXResponse_Opc) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FEXResponse_Opc.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "FEXResponse_Opc"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Opc"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://ar.gov.afip.dif.fexv1/", "ClsFEXResponse_Opc"));
