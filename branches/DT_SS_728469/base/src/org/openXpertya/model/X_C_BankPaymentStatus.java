...
/** AD_Table_ID */
public static final int Table_ID = M_Table.getTableID("C_BankPaymentStatus");

/** TableName=C_BankPaymentStatus */
public static final String Table_Name="C_BankPaymentStatus";

protected static KeyNamePair Model = new KeyNamePair(Table_ID,"C_BankPaymentStatus");
...
{
set_ValueNoCheck ("C_BankPaymentStatus_ID", new Integer(C_BankPaymentStatus_ID));
}
