 ...
 *  @version  - 2019-04-24 10:25:03.695 */
...
{
if (TransferBankAccountType == null || TransferBankAccountType.equals("CA") || TransferBankAccountType.equals("CC") || ( refContainsValue("T008-AD_Reference-1010416", TransferBankAccountType) ) );
 else throw new IllegalArgumentException ("TransferBankAccountType Invalid value: " + TransferBankAccountType + ".  Valid: " +  refValidOptions("T008-AD_Reference-1010416") );
...
{
if (TransferConcept == null || TransferConcept.equals("FAC") || TransferConcept.equals("ALQ") || TransferConcept.equals("CUO") || TransferConcept.equals("EXP") || TransferConcept.equals("HON") || TransferConcept.equals("PRE") || TransferConcept.equals("SEG") || TransferConcept.equals("VAR") || ( refContainsValue("T008-AD_Reference-1010417", TransferConcept) ) );
 else throw new IllegalArgumentException ("TransferConcept Invalid value: " + TransferConcept + ".  Valid: " +  refValidOptions("T008-AD_Reference-1010417") );
